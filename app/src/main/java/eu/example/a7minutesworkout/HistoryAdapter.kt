...
import eu.example.a7minutesworkout.databinding.ItemHistoryRowBinding
...
class HistoryAdapter(private val items: ArrayList<String>): RecyclerView.Adapter<HistoryAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
       val date: String = items[position]
        ...
        if(position%2 ==0) holder.llHistoryItemMain
            .setBackgroundColor(ContextCompat
                .getColor(holder.itemView.context,
                    R.color.lightGrey))

        else holder.llHistoryItemMain.setBackgroundColor(Color
            .parseColor("#FFFFFF"))
    }
}